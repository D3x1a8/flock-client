        ...
        <div className="model_container">
            <div className="modal" onClick={props.onClose}>
                <div className="model-content" onClick={e => e.stopPropagation()}>
                    ...
                    <VideoComponent encryptedUrl={props.content.trailer} />
                        <button type="button" onClick={props.onClose} class="close">
                            <RxCross1 />
                        </button>

                        <div class="header-content">
                            <div class="header-title">
                                <img src={props.content.imgTitle} alt="Tears Of Steel" />
                                ...
                                <div class="header-buttons">
                                    ...
                                    <button type="button" class="volume">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="modal-body">
                        <div class="modal-content-first">
                            <div class="modal-description">
                                ...
                                <span>{props.content.video_duration} mins</span>
                                <span class="description-badge">HD</span>
                            ...
                            {readMore ? <p className="content_desc">{props.content.desc.substring(0,320)  + "..."}<div onClick={() => setReadMore(!readMore)} className="read_more">Read More</div></p> : <p className="content_desc">{props.content.desc  + "..."}<div onClick={() => setReadMore(!readMore)} className="read_more">Read Less</div></p>}
                        ...
                        <div class="modal-content-second">
                            {/* <div class="cast">
                                ...
                                <span class="sub-title">Vanja Rukavina,</span>
                                <span class="sub-title">Denise Rebergen,</span>
                                <span class="sub-title">Rogier Schippers,</span>
                                <span class="sub-title">Derek de Lint,</span>
                                <span class="sub-title">Sergio Hasselbaink,</span>
                                <span class="sub-title">more.</span>
                            </div> */}

                            <div class="genres">
                                <span class="title">Genres:</span>
                                {props.content.genre.map(genre =>(
                                    <span>{genre}</span>
                                ))}
                            </div>

                            {/* <div class="show">
                                <span class="title">This show is:</span>
                                <span class="sub-title">Fictional war,</span>
                                <span class="sub-title">killer robot,</span>
                                <span class="sub-title">man vs machine.</span>
                            </div> */}
                        </div>
                    </div>
                </div>
